          ...
          <div
               ...
               onClick={() =>
                    navigator.clipboard
                         ...
                         .then(() =>
                              successMessage("Location copied to clipboard")
                         )
               }
          >
               <Icon icon="file-copy" />
...
export const DriverIsActive = (isActive: boolean = false) => {
     return (
          <span
               className={`driver-is-active ${isActive ? "active" : "inactive"
                    }`}
          >
...
export const AppVersion = (app_version: string) => (
     <div className="app_version">
          <Icon icon="android" className="green mr-4" />{" "}
          ...
          return (
               <div className={`driver-condition ${status}`}>
                    <span className="driver-condition-title">
                         {status !== "cycle"
                              ? moment
                                   .utc(statusTimeLeft * 1000)
                                   .format("HH:mm")
                              : `${Math.trunc(statusTimeLeft / (60 * 60))}` ??
                              0}
                    </span>
