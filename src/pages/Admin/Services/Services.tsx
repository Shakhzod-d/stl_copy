...
const Services: React.FC = () => {
     ...
     const { data, isLoading: getLoading, isRefetching, refetch } = useApi<IPageData<IServiceData[]>>("/main", { search, page, limit: PAGE_LIMIT });

     //action mutations
     const { mutate: updateService, isLoading: updateLoading } = useApiMutationID("PUT", "/service");
     const { mutate: deleteService, isLoading: deleteLoading } = useApiMutationID("DELETE", "/service");
