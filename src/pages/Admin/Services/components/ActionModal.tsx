...
const ActionModal: React.FC<Props> = ({ toggle, id, onSuccess }) => {
     ...
     const { data, isLoading } = useApi(`/services/${id}`, {}, { enabled: Boolean(id) });

     //action mutations
     const { mutate: createMutate, isLoading: createLoading } = useApiMutation("service");

     const { mutate: updateMutate, isLoading: updateLoading } = useApiMutationID("PUT", "service");
