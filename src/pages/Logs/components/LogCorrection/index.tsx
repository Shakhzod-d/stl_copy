...
const LogCorrection: React.FC<ILogCorrection> = ({
     ...
     useEffect(() => {
          ...
          reset({
               ...
               trailers: currentLog?.trailer || "",
          });
          setFromTo([
               moment.unix(currentLog?.start || 0),
               moment.unix(currentLog?.end || 0),
          ]);
     }, [currentLog]);

     const submit = (formData: TFormConnection) => {
          // console.log(initialTime - moment(formData.fromTo[0]).valueOf());
          // console.log(moment(formData.fromTo[1]).forma   t("HH:mm:ss"));
          // setLogs((prev) => {
                    ...
                    <div className="log-correction-form">
                         <div>
                              ...
                              <Row gutter={[40, 15]}>
                                   ...
                                   <Col span={20}>
                                        <TextField
                                             label={formNames.trailers}
                                             placeholder={formNames.trailers}
                                             name={formNames.trailers}
                                             control={control}
                                             required
                                        />
