...
import InsertInfoLog, { IInsertInfoLogFormData } from "./components/InsertInfoLog";
...
const LogActions: React.FC<ILogActions> = ({
     ...
     const onDateChange = (type: "prev" | "next") => {
          if (type === "next") setTime(momentZone(initialTime).add(1, "day").valueOf());
                    ...
                    {!currentLog ? (
                         <>
                              <Button
                                   ...
                                   onClick={() =>
                                        historyPush(
                                             `/main/trackings/inner/${driverData?._id}?time=${momentZone(initialTime).unix()}` // there is to be added ID
                                        )
                                   }
                              >
                                   Tracking
