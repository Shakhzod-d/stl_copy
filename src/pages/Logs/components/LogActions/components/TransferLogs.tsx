...
const TransferLogs: React.FC<{
     ...
     isVisibleTransfer,
          ...
          useEffect(() => {
               ...
               setDuration(
                    currentLog
                         ? currentLog?.end - currentLog?.start + initialTime
                         : 0
               );
               // }
          }, [currentLog]);
          ...
          return (
               <div>
                    ...
                    <p className="color-main medium-16 mb-4">
                         STL ELD Inc, as your service provider, is not responsible for
                         any financial or legal repercussions resulting from
                    ...
                    <div className="d-flex justify-end mt-32">
                         <Button
                              ...
                              type="primary"
                              disabled={
                                   transferStatus === "loading" || duration === 0
                              }
                         >
                              OK
                         </Button>
