...
const HistoryTable: FC<IHistoryTable> = ({
  ...
  const [currentHistoryGraph, setCurrentHistoryGraph] = useState<IHistoryLog>();
        ...
        <Row gutter={[16, 16]}>
          <Col span={12}>
            ...
            <Graph
              ...
              initialTime={currentHistoryGraph?.beforeLogs[0].start}
            />
            <Table
          ...
          <Col span={12}>
            ...
            <Graph
              ...
              initialTime={currentHistoryGraph?.afterLogs[0].start}
            />
            <Table
